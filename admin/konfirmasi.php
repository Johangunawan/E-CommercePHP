    ...
    <div id="content">
      ...
      <div id="container">
            <div class="items">
              ...
              <div class="cl">&nbsp;</div>
				<div style="width:940px;height:200px;border:1px dashed #B0C4DE;">
				&nbsp
		<center><table>
			<!--<tr>
			...
			<tr>
				<td width="120">Order Refference</td>
				<td width="350">
				<input name="Order" type="Order" id="Order" size="40" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="120">Atas Nama(A/N)</td>
				<td width="350">
				<input name="Nama" type="Nama" id="Nama" size="40" />
				</td>
			</tr>
			<tr>
				<td width="120">Jumlah Trf</td>
				<td width="350">
				<input name="Transfer" type="Transfer" id="Transfer" size="40" />
				</td>
			</tr>
			<tr>
				<td width="120">Date/Time</td>
				<td width="350">
				<input name="Date" type="Date" id="Date" size="40" />
				</td>
			</tr>
			<tr>
				<td width="120">Notes</td>
				<td width="350">
				<input name="Notes" type="Notes" id="Notes" size="40" />
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
