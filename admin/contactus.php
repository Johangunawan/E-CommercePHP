    ...
    <div id="content">
      ...
      <div id="container">
            <div class="items">
              ...
              <div class="cl">&nbsp;</div>
				<div style="width:940px;height:550px;border:1px dashed #B0C4DE;">
					<p style="padding: 15px;line-height:23px;color:#1a356e;">
						<center><h4>Area Jakarta</h4>&nbsp
						<li>SMS/Whatsapp : 089618563214 </li>
						<li>BB Pin : 28C38FB8 </li>
						<li>LINE : shoesprojects016</li>
						
						&nbsp<h4>Area Bandung</h4>&nbsp
						<li>SMS/Whatsapp : 089618927920 </li>
						<li>BB Pin : 433CC987 </li>
						<li>LINE : shoesprojects017</li>
						
						&nbsp<h4>Area Bekasi</h4>&nbsp
						<li>SMS/Whatsapp : 083829114398 </li>
						<li>BB Pin : 2B0A3DA8  </li>
						<li>LINE : shoesprojects018</li>
						
						&nbsp<h4>Area Depok</h4>&nbsp
						<li>SMS/Whatsapp : 083820464846 </li>
						<li>BB Pin : 28FA1BA9  </li>
						<li>LINE : shoesprojects019</li>
						
						&nbsp<h4>Costumer Care</h4>&nbsp
						<li>SMS : 083822348738</li>
						<li>LINE : shoescare</li>
						</center>	
					</p>
				</div> 
            </div>
